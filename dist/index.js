...
function lookup_scale(scale_type) {
  var scale_type_normalised = scale_type.toLowerCase();
  var scaleIndex = SCALES.findIndex(function (s) {
    var found = s.name.toLowerCase() === scale_type_normalised;
    if (found) return true;
    return s.alt_names ? s.alt_names.some(function (n) {
      return n.toLowerCase() === scale_type_normalised;
    }) : false;
  });
  if (scaleIndex === -1) {
